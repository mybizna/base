<div active form="about" id="admin-account" 
    ...
    <div>
        <div class="flex flex-wrap">
            <div class="col-span-full max-col-span-full px-3 mt-6 text-left flex-0">
                ...
                <div class="flex">
                    <div class="flex-auto px-1">
                        ...
                        <input name="first_name" type="text" name="First Name" placeholder="Eg. John"
                            class="mb-4 focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease-soft block col-span-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                    </div>
                    <div class="flex-auto px-1">
                        <label class="mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80"
                            for="Last Name">Last
