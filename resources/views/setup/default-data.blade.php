<div form="address"
    class="flex flex-col d-none col-span-full h-0 min-w-0 p-4 break-words bg-white border-0 opacity-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border">

    <div class="flex flex-wrap -mx-3 text-center">
        <div class="w-10/12 max-col-span-full px-3 mx-auto flex-0">
    ...
    <div>
        <div class="flex flex-wrap -mx-3 text-left">
            <div class="col-span-full max-col-span-full px-3 mt-4 ml-auto flex-0 md:w-8/12">
                ...
                <input type="text" name="Street Name" placeholder="Eg. Soft"
                    class="focus:shadow-soft-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease-soft block col-span-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
            </div>
            <div class="col-span-full max-col-span-full px-3 mt-4 ml-auto flex-0 md:w-4/12">
            ...
            <div class="col-span-full max-col-span-full px-3 mt-4 ml-auto flex-0 md:w-7/12">
            ...
            <div class="col-span-full max-col-span-full px-3 mt-4 ml-auto flex-0 md:w-5/12">
        ...
        <div class="flex flex-wrap -mx-3">
            <div class="flex col-span-full max-col-span-full px-3 mt-6 flex-0">
